...
# Form implementation generated from reading ui file 'C:\Users\Admin\Desktop\PrimerBuilder\test.ui'
#
...
class Ui_PrimerBuilder(object):
    def setupUi(self, PrimerBuilder):
        ...
        self.tag_other = QtWidgets.QLabel(self.centralwidget)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("95705-200.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, PrimerBuilder):
        ...
        self.label.setText(_translate("PrimerBuilder", "TextLabel"))
        self.radioButton.setText(_translate("PrimerBuilder", "RadioButton"))
        self.radioButton_2.setText(_translate("PrimerBuilder", "RadioButton"))
        self.DNAsequence.setText(_translate("PrimerBuilder", "DNA SEQUENCE"))
        self.tm.setText(_translate("PrimerBuilder", "Tm"))
        self.label_2.setText(_translate("PrimerBuilder", "TextLabel"))
        ...
        self.credit_1.setText(_translate("PrimerBuilder", "PrimerBuilder Reborn v1.2 by Hyunjong Byun powered by SequenceProcessor v2.2 by Hyunjong Byun."))
